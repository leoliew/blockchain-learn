...
async function main () {
  ...
  // 使用已部署的合约进行测试
  const AAVE_FLASH_ADDRESS = '0xF24d4d837052d9C5aB2546DC9A0546c03D3a66e0'
  ...
  await busdToken.connect(wallet1).transfer(aaveFlashLoan.address, ethers.utils.parseUnits('0.01', 18))
  await aaveFlashLoan.connect(wallet1).testFlashLoan(busdToken.address, ethers.utils.parseUnits('0.05', 18))
